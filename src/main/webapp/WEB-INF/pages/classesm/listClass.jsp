...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang">
  <tr>
    ...
    <td width="36%"align="right">
        ...
        <s:a action="classAction_preAddOrEdit">
...
<thead>
  ...
  <s:iterator value="%{#allClazz}" status="sl">
	  ...
	  <tr class="<s:property value="#sl.even ? 'tabtd2':'table1'" />">
		  ...
		  <td align="center">
			  ...
			  <s:a namespace="/" action="classAction_preAddOrEdit">
          ...
          <%-- 查看 --%>
          <td align="center">
              <s:a namespace="/" action="classAction_findById">
                  <s:param name="classId" value="classId"></s:param>
          ...
          <td align="center" title="上次上传时间：<s:date name='uploadTime' format='yyyy-MM-dd' />">
              <s:a namespace="/" action="classAction_preUpload">
                  <s:param name="classId" value="classId"></s:param>
                  上传
              </s:a>
              <s:if test="uploadFilename != null">
                  <s:a namespace="/" action="classAction_download">
                      <s:param name="classId" value="classId"></s:param>
                      下载
                  </s:a> <br/>
              </s:if>
