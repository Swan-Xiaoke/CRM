...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang">
	<tr>
		...
		<td width="63%"align="right">
			<%--添加咨询 --%>
			<s:a cssClass="butbg" namespace="/" action="referAction_preAddOrEdit">
...
<!-- 查询条件：添加或选择马上查询 -->
<s:form namespace="/" action="referAction_findAll">
	<s:hidden name="status" value="%{status}"></s:hidden>
	<table width="88%" border="0" style="margin: 20px;" >
		<tr>
			<td width="80px">查询条件：</td>
			<td width="300px">
				<s:textfield name="condition" size="20" onblur="document.forms[0].submit();"></s:textfield>（姓名|电话|QQ）</td>
			<td ></td>
		</tr>
	</table>
</s:form>
...
<table width="100%" border="1" >
	...
	<s:iterator value="#allRefer" status="vs">
		<tr class="<s:property value="#vs.odd ? 'tabtd2' : 'tabtd1'" />">
			...
			<td align="center">
				<s:property value="courseType.courseName"/>/
				<s:property value="clazz.name"/>
			</td>
			<td align="center">
			...
			<td width="8%" align="center">
				<s:a namespace="/" action="referAction_findById">
			...
			<s:if test="status == 1">
				<!-- 编辑 -->
				<td width="8%" align="center">
					<s:a namespace="/" action="referAction_preAddOrEdit">
						<s:param name="referId" value="%{referId}"></s:param>
				...
				<!-- 添加跟踪 -->
				<td width="8%" align="center">
					<s:a namespace="/" action="followAction_preAddOrEdit">
						<s:param name="refer.referId" value="%{referId}"></s:param>
				...
				<!-- 入学 -->
				<td width="8%" align="center">
					<s:a namespace="/" action="referAction_preAddStudent">
						<s:param name="referId" value="referId"></s:param>
						<img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/>
					</s:a>
				</td>
