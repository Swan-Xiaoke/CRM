								...
								<tr>
									<td width="51" valign="middle">
										...
										<s:a namespace="/" target="right" action="UIAction_staff_updPwd">
											<s:param name="loginName">
												<s:property value="#sessionScope.loginName"/>
											</s:param>
											<s:param name="loginPwd">
												<s:property value="#sessionScope.loginPwd"/>
											</s:param>
											<font color="ffffff">更改密码</font>
										</s:a>
									</td>
										<td width="55" valign="middle">
											<a href="${pageContext.request.contextPath}/returnAction.action" target="_top"><font color="ffffff">重新登录</font></a></td>
								</tr>
							</table>
						</div>
						</td>
