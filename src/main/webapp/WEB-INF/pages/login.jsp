	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1" >
		...
		<tr align="center" >
			...
			<td class="login_msg" width="400">
				...
				<s:form action="staffAction_login" namespace="/" theme="simple">
					...
					<br/>
					账户：<s:textfield label="用户名" name="loginName" cssClass="msg"/><br/><br/>
					密码：<s:password label="密码" name="loginPwd" cssClass="msg"/><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
