...
<s:iterator value="posts" status="sl" var="post">
    <tr class="<s:property value="#sl.even ? 'tabtd2':'table1'" />">
	    <td align="center">${post.dept.depName}</td>
	    <td align="center">${post.postName}</td>
	  	<td width="7%" align="center">
            <a href="postAction_addOrEditPre.action?postId=${post.postId}&dept.depId=${post.dept.depId}&postName=${post.postName}">
