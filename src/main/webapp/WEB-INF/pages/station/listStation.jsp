...
<table width="100%" border="1" >
  ...
  <tr class="henglan" style="font-weight:bold;">
    ...
    <s:iterator value="%{#allStation}" status="sl">
   <tr class="<s:property value="#sl.odd ? 'tabtd2' : 'tabtd1'" />">
       <td align="center"><s:property value="student.name"/></td>
       <td align="center"><s:date name="createDate"/> </td>
       <td align="center"><s:property value="@com.lanou.crm.macro.MacroDefinition@STUDENT_STATUS[flag]"/> </td>
